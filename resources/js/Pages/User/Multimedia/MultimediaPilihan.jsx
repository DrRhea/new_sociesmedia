...
const MultimediaPilihan = () => {
  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false);
  const [activeTab, setActiveTab] = useState('all'); // Tab aktif

  const list = [
    { title: "Video", img: "https://placehold.co/600x400?text=Sociesmedia", category: 'video' },
    { title: "Podcast", img: "https://placehold.co/600x400?text=Sociesmedia", category: 'podcast' },
    { title: "Poster", img: "https://placehold.co/600x400?text=Sociesmedia", category: 'poster' },
    { title: "Games", img: "https://placehold.co/600x400?text=Sociesmedia", category: 'games' },
  ];
    ...
    <div className="bg-white">
      ...
      <main className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="pb-10 border-b border-gray-200">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Multimedia</h1>
          <p className="mt-4 text-base text-gray-500">
            Pilih multimedia dan filter berdasarkan jenis untuk menemukan konten yang Anda butuhkan.
          </p>
        </div>
