...
class ManajemenMultimediaController extends Controller
{
    ...
    public function update(Request $request, string $slug)
    {
        ...
        // Update konten jika tipe adalah poster dan file baru diberikan
        if ($request->type === 'poster' && $request->hasFile('content')) {
            ...
            // Jika bukan poster atau tidak ada file baru, gunakan URL dari input
            $validatedData['content'] = $request->input('content');
        }
